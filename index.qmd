...
As we are completing the videos, we are uploading them to YouTube, but leaving them unlisted. We plan on making them public in May 2025. You are free to look at them now, but they are missing the description with links, the closed captioning, and the card links at the end. The current list of uploaded videos is [here](https://dofpro.org/CTP/basics/intro/CurrentVideoList.html).
